...
export const AboutPage = () => {
  return (
    ...
    <div className='history'>
      ...
      <p>Fundada en 2023 por Alan Nakagawa, Nuestra Tienda comenzó como un pequeño negocio en línea que vendía productos artesanales. Con el tiempo, nuestra dedicación a la calidad y la satisfacción del cliente nos permitió crecer y expandirnos en nuevos mercados.</p>
    </div>
    <div className='team'>
